...
const Sidebar = () => {
  return (
    <div className=" flex flex-col h-screen justify-between  items-center md:items-start  text-white">
        ...
        <div className="flex flex-col gap-9 mt-4 items-center md:items-start">
          {sidebar.map(({ id, title, icon: Icon, link }) => (
            <Link
              key={id}
              to={link}
              className="flex items-center gap-2 text-white max-[807px]:text-sm"
            >
