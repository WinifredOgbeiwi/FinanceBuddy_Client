...
const Settings = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    if (auth.user && auth.user._id) {
      dispatch(editUserDetails({ id: auth.user._id, userData }))
        .unwrap()
        .then(() => {
          dispatch(fetchUserDetails(auth.user._id)); 
          ...
          <form onSubmit={handleSubmit} className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                placeholder={userDelts.occupation ? userDelts.occupation : "Enter occupation"}
            ...
            <CountrySelect
              ...
              className={userData.location === null ? 'text-gray-400' : 'text-gray-800'}
              defaultText={userDelts.location ? userDelts.location : "Select a country"}
            />
            ...
            <div className='col-span-2 relative'>
              <label htmlFor="firstname" className="block">Old Password</label>
              <input
              ...
              />
              <div onClick={() => setShowPassword({ ...showPassword, oldPassword: !showPassword.oldPassword })} className="absolute top-[42px] right-2 cursor-pointer">
                {showPassword.oldPassword ? <AiFillEyeInvisible /> : <AiFillEye />}
              </div>
            </div>

            <div className='col-span-2 relative'>
              <label htmlFor="firstname" className="block">New Password</label>
              <input
                ...
                onFocus={() => setIsFocused({ ...isFocused, newPasswordValidation: true })}
                placeholder="• • • • • • • •"
                className="w-full border-2 rounded-[3px] p-2 mt-[3px] border-main outline-none  "
              />
              <div onClick={() => setShowPassword({ ...showPassword, newPassword: !showPassword.newPassword })} className="absolute top-[42px] right-2 cursor-pointer">
            ...
            <div className='col-span-2 relative'>
              <label htmlFor="firstname" className="block">Confirm Password</label>
              <input
            ...
            <div className="col-span-2">
              <Button text="Save Changes" type="submit" specific="filled_button" />
            </div>
          </form>
